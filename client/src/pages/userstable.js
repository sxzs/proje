...
export default connect(mapStateToProps, { getUsers, deleteUser })(MyTable);
...
const rows = [
    createData('Cupcake', 'test@test.com', 1, 'admin', ),
    createData('Donut', 'test1@test.com', 1, 'user'),
    createData('Eclair', 'test2@test.com', 2, 'user'),
    createData('Frozen yoghurt', 'test3@test.com', 3, 'user'),
    createData('Gingerbread', 'test4@test.com', 's', 'user'),
    createData('Honeycomb', 'test5@test.com', 'd', 'user'),
